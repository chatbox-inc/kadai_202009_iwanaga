  ...
  <div>
        ...
        <div class="header-top">
          <div class="left">
            ...
            <div class="site-heading">
              <img src="http://www.sanch-gondo.jp/cms/wp-content/themes/sanch/img/logo-v-w.svg" alt="SANCH">
              </div>
    ...
    <div class="container">
          ...
          <div class="post-preview">
              <p>News 2020.05.18<br>
              <a href="http://www.sanch-gondo.jp/news/140">
           　　　　　Webサイトをリニューアルしました</a></p>
              <h3 class="post-title">
                What's
              </h3>
             ...
             <img src="blueberry6.png">
             <img src="blueberry7.png">
             <img src="blueberry8.png">
            ...
            <p class="post-meta">長野県長野市権堂町にある、<br>
                  ...
                  こだわりの食パン、ボリューミーなサンドイッチ、<br>
                  旬の果物をふんだんに使ったパフェなど、<br>
                  フルーツとパンのある毎日をお届けします。
                  <a href="/about"><br>Concept<br>→</a>
            </p>
          ...
          <div class="post-preview">
            ...
            <p class="shokupan">サンチの食パンは、信州生まれの小麦粉や牛乳を使った、甘みとミルクの風味に包まれた、柔らかくて優しい食パンです。大切な人に教えたい、自慢したい食パンを目指しています。</p>
            <p class="more">More→</p>
            <img src="syokupan.png" width="100%" height="auto">

            <li>
            <div class="fruit">
            <p>Fruit</p>
            <h2>果実の魅力を<br>最大限に引き出すために。</h2>
            <p>食べごろ、食べ方、適した加工。フルーツにみずみずしい命を吹き込んだ農家の方々と語らうことで、食パンの美味しさとフルーツの味わいをお互いが引き立てるサンドイッチが完成します。</p>
            <p>More→</p></div></li>
            ...
            <p>More→</p>
            <img src="fruitsand.pn" alt class=sand1>
            <img src="chocobananasand.pn" alt class="sand2">
            <img src="yasaisand.pn" alt class="sand3">
             ...
             <p>サンチのはなし</p>
              ...
              <div class="ichigo">
                ...
                <h3>いちごのはなし</h3>
                <p>いちごの旬の季節 春！満開な4月中旬、須坂市の小林いちご園の小林さんにサンチのはなしを伺いに。</p>
              </div>
             ...
             <div class="budou">
               <div>
                ...
                <h3>ぶどうのはなし</h3>
                <p>秋も深まる9月。 サンチで使用する葡萄を作っていらっしゃる ぶどう農家さん・千曲市の昇陽園さんに旬を迎えたぶどうのサンチのはなしを伺いに行ってきました。</p>
              ...
              <div class="komugi">
                ...
                <h3>小麦のはなし</h3>
                <p>早朝、前日までの雨が上がり、むんむんとした空気と暑い夏の日差しが照り付けるなか、浅間山をのぞむ丘の上の小麦畑で長野県産小麦の収穫見学と、柄木田製粉さんの宮崎製造本部長と北島さんにサンチのはなしをお聞きしてきました。</p>
              </div>
      ...
      <ul class="event1">
        ...
        <div class=event>
          ...
          <p>MY IDEA SANCH 2020<br>　～あなたが食べたい夢のサンドイッチを<br>教えてください～　結果発表！！</p></div>
            ...
            <p>営業時間</p>
            <h2>10:00 - 17:00</h2><span>(L.O 16:30)</span>
            <p>LUNCH 11:00 - 15:00(L.O 14:30)
            <br>一部の商品を除きテイクアウトOK
            <br>店内無料Wi-Fi / カウンター席はコンセント有
        ...
        <div class="flexmap">
          <img src="map.svg" width="100%" height="auto">
           ...
           <img src="nagano.station.png" width="100%">
            ...
            <div class="sns">
            <h2>Facebook</h2>
            <a href="https://www.facebook.com/sanch.gondo/"></a>
            <div class="facebook">
            <p>フルーツ&ブレットサンチ</p>
            ...
            <p>Instagram</p><br>@sanch.gondo
            <a href="https://www.instagram.com/sanch.gondo/"></a>
